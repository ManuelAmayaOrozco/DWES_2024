...
public class UserAdRepository implements UserAdRepositoryAPI{
    ...
    public UserAdRepository() {
        ...
        bddUserAd.add(new UserAd("Diego", "diego@diego.es", "0bce9ed17b74edb9a41ee60f2bdc111f0b76a28b02561b2e3b3ad15bc9b1805d", true)); //pass: sSHEcjlt
        bddUserAd.add(new UserAd("Marta", "marta@diego.es", "619b4ad13104bb2a80742ae65d8a9e4af2240652430d3eda9ae39e22a037e8cc", false)); //pass: 2FGoRkS2
        bddUserAd.add(new UserAd("Juan", "juan@diego.es", "6cebe4ef0bc991e87ee6ecc7aed7e7fbc5f61601a8708b7d30a73e9d4eafc69b", false)); //pass: nrd32sC7
        bddUserAd.add(new UserAd("Billy", "billy@diego.es", "8ea8d3a151a989fbce578fc80c02993075d0ad925660427c8462ef12aea29dc8", false)); //pass: 6DHMvsON
        bddUserAd.add(new UserAd("Joe", "joe@diego.es", "47092541925345fd6422a41ae9ebb9ea844e0f9047a0bf728d51cb40769f4fb9", true)); // pass: L456xwbd
    }
